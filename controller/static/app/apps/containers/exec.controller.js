(function(){
	...
	angular
		...
		.controller('AppExecController', AppExecController);

	AppExecController.$inject = ['$http', '$stateParams', 'AppContainerService'];
	function AppExecController($http, $stateParams, AppContainerService) {
            var vm = this;
