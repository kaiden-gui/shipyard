(function(){
    ...
    angular
        ...
        .controller('AppContainerStatsController', AppContainerStatsController);

    AppContainerStatsController.$inject = ['$stateParams', '$scope'];
    function AppContainerStatsController($stateParams, $scope) {
        var vm = this;
        var graphCpuStats;
