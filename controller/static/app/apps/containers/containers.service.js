(function(){
    ...
    angular
        ...
        .factory('AppContainerService', AppContainerService)

        AppContainerService.$inject = ['$http'];
    function AppContainerService($http) {
        return {
            list: function(label) {
                var promise = $http
                    .get('/containers/json?all=1&filters={"label":["appname='+label+'"]}')
