(function(){
    ...
    angular
        ...
        .controller('AppContainerDeployController', AppContainerDeployController);

    AppContainerDeployController.$inject = ['containers', '$http', '$state'];
    function AppContainerDeployController(containers, $http, $state) {
        var vm = this;
